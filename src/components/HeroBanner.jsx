      ...
      <Wrapper>
        ...
        >
          <div className="flex items-center gap-[6px]">
            ...
            <div>ps8494248@gmail.com</div>
          </div>
          <div className="cursor-pointer px-5 py-2 hover:bg-slate-900 transition active:scale-90 rounded-lg transition:0.3s"><a href="https://drive.google.com/file/d/1TVcmkBu8dH7J5uAfD0xHh8Gihtu9c4zB/view?usp=sharing" className="button">Download CV</a>
          </div>
        ...
        >
          <div className="font-light mb-4">
            👋 Hi, I Am <span className="font-semibold">Prabhjot Singh</span>
          </div>
          <div className="max-w-[510px]">
            I am a Passionate Front-end Developer. I create and maintain
            modern websites and applications. I solve all your business
            problems.
          </div>
        </motion.div>
        {/* INTRO END */}
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <div className="text-[80px] font-light">30+</div>
        ...
        >
          ...
          <div
            className="absolute top-[140px] -right-20 2xl:top-[240px] 2xl:-right-10 w-[140px] h-[140px] rounded-full bg-white/[0.7] flex flex-col justify-center items-center gap-2 backdrop-blur-sm cursor-pointer transition-transform scale-[0.65] md:scale-100 active:scale-[0.55] md:active:scale-90"
            onClick={() => scrollTo("contact")}
          >
